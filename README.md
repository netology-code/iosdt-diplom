...
Для того, чтобы условия разработки были максимально приближенными к реальности, весь дизайн приложения отрисован в figma - [проект](https://www.figma.com/file/z7Z9JYnxoOI4g4nVCX8BYU/погода?node-id=0%3A1) [резервная копия](./погода.fig).  Все картинки и цвета и расположения элементов находятся в проекте figma. 
